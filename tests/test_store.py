...
class TestResultStore(unittest.TestCase):
    ...
    def test_generate_file_name(self):
        ...
        #test should throw value error if rcut is not an int or float
    ...
    def test_store_descriptor(self):
        ...
        r3 = rs("./tests/results")
        result = "Random test result" #String
        desc = "test_desc"
        aid = "aid_111"
        fname = "filename"
    ...
    def test_get_descriptor(self):
        ...
        #pull results from test_result_store
        #Test if not .npy file
